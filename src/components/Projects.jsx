...
import laundryserviceImg from '../assets/projects/laundryservice.ae.jpg';
import contentscanImg from '../assets/projects/contentscan.ai.jpg';
import carpetwashingImg from '../assets/projects/carpetwashing.ae.jpg';
import metadigitalmarketingImg from '../assets/projects/metadigitalmarketing.ae.jpg';
import seaherowatersportsImg from '../assets/projects/seaherowatersports.com.jpg';
import chocolateshopImg from '../assets/projects/chocolateshop.ae.jpg';
import alfajewellersImg from '../assets/projects/alfajewellers.live.jpg';
import technicalplusImg from '../assets/projects/technicalplus.ae.jpg';

const projectImages = {
  'laundryservice.ae.jpg': laundryserviceImg,
  'contentscan.ai.jpg': contentscanImg,
  'carpetwashing.ae.jpg': carpetwashingImg,
  'metadigitalmarketing.ae.jpg': metadigitalmarketingImg,
  'seaherowatersports.com.jpg': seaherowatersportsImg,
  'chocolateshop.ae.jpg': chocolateshopImg,
  'alfajewellers.live.jpg': alfajewellersImg,
  'technicalplus.ae.jpg': technicalplusImg,
};
  ...
  >
    <div className={`rounded-2xl p-6 md:p-8 h-full backdrop-blur-md transition-all duration-500 ${
      ...
      {project.image && projectImages[project.image] && (
        <div className="w-full aspect-video rounded-xl overflow-hidden mb-6 border border-white/10 relative">
          <img
