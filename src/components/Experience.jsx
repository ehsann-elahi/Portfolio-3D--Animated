      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-red-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
            From internships to production AI systems — a track record of shipping real, live software.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          {experienceList.map((job, index) => (
            <ExperienceCard key={job.organization + job.role} job={job} index={index} />
          ))}
        </div>
