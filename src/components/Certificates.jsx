    ...
    <section className="bg-[#ff2a2a] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        {certificates.featured.length > 0 ? (
          ...
          <div data-aos="fade-up" className="flex justify-center mb-4">
            <p className="text-white/80 text-sm md:text-base font-semibold bg-black/10 border border-black/10 rounded-2xl px-6 py-4 max-w-md text-center">
